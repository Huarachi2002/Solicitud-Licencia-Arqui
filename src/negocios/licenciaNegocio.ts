...
class LicenciaNegocio {
    ...
    async aprobarLicencia(id_licencia: number, id_usuario_aprobador: number) {
        ...
        return await licenciaDato.aprobarLicencia(id_licencia, LicenciaEstado.APROBADA, id_usuario_aprobador);
    }
    async rechazar(id_licencia: number, id_usuario_rechazo: number) {
        return await licenciaDato.rechazarLicencia(id_licencia, LicenciaEstado.RECHAZADA, id_usuario_rechazo);
    }
